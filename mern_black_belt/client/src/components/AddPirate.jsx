...
const AddPirate = () => {
    ...
    const[crew_position, setCrewPostion] = useState("captain");
    ...
    let captainFilter = pirates.map(item => item.crew_position).filter( pirate => pirate.includes("captain") );
    

    const onSubmitHandler = (e) => {
        e.preventDefault();
        crew_position.includes("captain") && captainFilter.includes("captain") ?
        console.log("There can only be one captain")
        :
